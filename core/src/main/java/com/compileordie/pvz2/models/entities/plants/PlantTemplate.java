...
public class PlantTemplate {
    ...
    public void setActionIntervalTicks(int actionIntervalTicks) {
    ...
    public List<double[]> getShootVectors() {
        return shootVectors;
    }

    public void setShootVectors(List<double[]> shootVectors) {
        this.shootVectors = shootVectors;
    }
    ...
    public void setInstantKill(boolean instantKill) {
        this.isInstantKill = instantKill;
    }
