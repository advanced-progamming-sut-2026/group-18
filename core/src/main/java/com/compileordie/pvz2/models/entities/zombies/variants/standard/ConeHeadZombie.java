...
public class ConeHeadZombie extends StandardZombie {
    ...
    public ConeHeadZombie(double health, double speed, int attackPower, int row, double startX, double initialArmor, double x, double y, double xSpeed, double ySpeed) {
