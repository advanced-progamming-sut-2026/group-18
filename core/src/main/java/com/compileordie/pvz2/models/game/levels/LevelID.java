...
public enum LevelID {
    ...
    STANDARD_DARK_AGES(ChapterType.FROSTBITE_CAVES, LevelType.STANDARD, 3),
    SAVE_OUR_SEEDS(ChapterType.FROSTBITE_CAVES, LevelType.SPECIAL, 4),
    TIMED_WAR(ChapterType.FROSTBITE_CAVES, LevelType.SPECIAL, 5),
    BOSS_DARK_AGES(ChapterType.FROSTBITE_CAVES, LevelType.BOSS, 6),
    ...
    STANDARD_FROSTBITE_CAVES(ChapterType.DARK_AGES, LevelType.STANDARD, 3),
    LOVE_YOUR_PLANTS(ChapterType.DARK_AGES, LevelType.SPECIAL, 4),
    PLANT_WHAT_YOU_GET(ChapterType.DARK_AGES, LevelType.SPECIAL, 5),
    BOSS_FROSTBITE_CAVES(ChapterType.DARK_AGES, LevelType.BOSS, 6),
    VASE_BREAKER(0),
    WALNUT_BOWLING(5),
    I_ZOMBIE(0),
    BEGHOULED(-1),
