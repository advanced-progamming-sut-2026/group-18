...
public enum LevelID {
    ...
    BOSS_ANCIENT_EGYPT(ChapterType.ANCIENT_EGYPT, LevelType.ZOMBOSS, 6),
    ...
    BOSS_FROSTBITE_CAVES(ChapterType.FROSTBITE_CAVES, LevelType.ZOMBOSS, 6),
    ...
    BOSS_BIG_WAVE_BEACH(ChapterType.BIG_WAVE_BEACH, LevelType.ZOMBOSS, 6),
    ...
    BOSS_DARK_AGES(ChapterType.DARK_AGES, LevelType.ZOMBOSS, 6),
    VASE_BREAKER(0),
    WALNUT_BOWLING(5),
    I_ZOMBIE(0),
    BEGHOULED(-1),
