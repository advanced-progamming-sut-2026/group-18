...
public class PlantAssetManager {
    ...
    private String getPath(PlantType plantType) {
        return switch (plantType) {
            ...
            case CAT_TAIL -> "768/FULL/PLANT/PRIMAL_PEASHOOTER/PRIMAL_PEASHOOTER.PAM";
            ...
            case PIERCE_MINT -> "768/INITIAL/EMPOWERMINTS/PLANT/SPEARMINT/SPEARMINT.PAM";
            case CATTAIL_MINT -> "768/INITIAL/EMPOWERMINTS/PLANT/FILAMINT/FILAMINT.PAM";
        };
    }
