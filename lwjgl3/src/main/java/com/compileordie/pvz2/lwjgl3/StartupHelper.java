...
package com.compileordie.pvz2.lwjgl3;
...
public class StartupHelper {
    ...
    private static final String CHILD_LOOP_ERR_MSG =
        "The current JVM process is a spawned child JVM process, but StartupHelper has attempted to spawn "
            + "another child JVM process! This is a broken state, and should not normally happen! "
